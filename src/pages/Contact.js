...
export default function Contact() {
	return (
		<section className="Contact min-h-screen md:px-[70px]">
			<Header />
			<div className="bg-[#FAFAFA] h-[60px] md:mx-[-70px]"></div>
			<div className="mt-20 flex items-center justify-center flex-col md:mb-0 mb-20">
				...
				>
					<div className="flex flex-col mb-[30px]">
						...
						<input
							...
							className="md:w-[450px] w-[350px] h-[50px] border-2 border-black placeholder:font-light placeholder:text-[#636363] placeholder:pl-5 placeholder:tracking-wider"
						/>
					</div>
					<div className="flex flex-col mb-[30px]">
						<label
					...
					<div className="mt-10">
						<button className="md:w-[450px] w-[350px] h-[60px] text-center text-white bg-[#3e3d3d] tracking-wider font-medium text-xl">
							SIGN IN
						</button>
					</div>
				</form>
